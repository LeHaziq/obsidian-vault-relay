...
describe("versionsByPath", () => {
  it("groups mutations by path across operations", () => {
    const first: SyncOperation = {
      protocolVersion: 1, id: "op1", deviceId: "d", sequence: 1, createdAt: "2026-01-01T00:00:00.000Z",
      changes: [{ kind: "delete", path: "a.md", parents: [] }, { kind: "delete", path: "b.md", parents: [] }],
    };
    const second: SyncOperation = {
      protocolVersion: 1, id: "op2", deviceId: "d", sequence: 2, createdAt: "2026-01-02T00:00:00.000Z",
      changes: [{ kind: "delete", path: "a.md", parents: ["op1"] }],
    };
